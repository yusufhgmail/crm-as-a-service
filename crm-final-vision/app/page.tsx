...
const buildPath = [
  ['01', 'Connect approved team email', 'Choose which Gmail or Microsoft 365 accounts and history CRM From Within may read.'],
  ['02', 'Let the work reveal the structure', 'CRM From Within finds customers, relationships, stages, handoffs and the work people do outside a normal pipeline.'],
    ...
    <main>
      ...
      <section className="hero shell" id="top">
        <div className="hero-copy">
          ...
          <p className="hero-lede">If your small company does not have a CRM, connect your team’s email. CRM From Within discovers how your customer relationships work, then builds and fills one around them.</p>
      ...
      <section className="section build-section shell" id="builds">
        <div className="section-heading split-heading">
          ...
          <p>Most CRMs make you decide the fields, stages and workflows before they know anything about the business. CRM From Within begins with what the team already does.</p>
        </div>
        ...
        <div className="build-output">
          ...
          <div className="output-arrow" aria-hidden="true"><span>CRM From Within discovers</span>→</div>
      ...
      <section className="section why-section" id="learns">
        <div className="shell why-grid">
          <div className="why-copy">
            ...
            <p>A click shows that something changed. It does not show the goal, the exception or the better process someone had in mind. CRM From Within can ask a short question at that moment and capture the answer without another requirements workshop.</p>
      ...
      <section className="section shared-learning shell">
        <div className="section-heading centered-heading">
          <p className="eyebrow">Your CRM learns locally. CRM From Within learns across every installation.</p>
        ...
        <div className="learning-map" aria-label="Private customer CRMs contribute approved reusable lessons to a shared learning system, which improves new and existing CRMs">
          ...
          <div className="learning-core"><span className="coremark-large" aria-hidden="true"><i /></span><small>CRM FROM WITHIN LEARNS</small><strong>Patterns that worked.<br />Mistakes to avoid.<br />Better ways to build.</strong></div>
      ...
      <section className="section comparison-section">
        <div className="shell">
          <div className="section-heading split-heading">
            <div><p className="eyebrow">Why build another kind of CRM?</p><h2>Automatic data entry is useful. CRM From Within changes the software itself.</h2></div>
            <p>AI-native CRMs already connect email and reduce manual logging. CRM From Within’s bet is that a small company should receive owned software whose structure and features are discovered from that company—not another shared product to configure.</p>
          </div>
          <div className="comparison-table" role="table" aria-label="Comparison of traditional CRM, AI-native CRM and the CRM From Within vision">
            <div className="comparison-row comparison-head" role="row"><div role="columnheader">The difference</div><div role="columnheader">Traditional CRM</div><div role="columnheader">AI-native CRM</div><div className="company-column" role="columnheader">CRM From Within vision</div></div>
      ...
      <section className="section ownership-section shell" id="ownership">
        <div className="ownership-copy"><p className="eyebrow">Built around your company. Controlled by your company.</p><h2>The CRM should learn without taking control away from the people using it.</h2><p>CRM From Within’s advantage cannot depend on trapping a customer. The customer owns the CRM, code and data. The service earns its place by continuing to improve them.</p></div>
        <div className="ownership-grid">
          ...
          <article><span>03</span><h3>You own what is built</h3><p>The CRM, code and data belong to the customer. CRM From Within keeps the reusable building method—not the customer’s private advantage.</p></article>
        </div>
      </section>

      <section className="section faq-section shell">
        <div className="section-heading split-heading"><div><p className="eyebrow">Before you press the button</p><h2>What this vision does—and does not—promise.</h2></div><p>The website shows the intended final experience. It does not claim that CRM From Within can already build a production CRM from your email.</p></div>
        <div className="faq-list">
          <details open><summary>Can I use CRM From Within today?</summary><p>Not as the one-click product shown here. CRM From Within is in development. The first stage is to build greenfield CRMs manually, learn from real use and turn the repeated parts into the product.</p></details>
          <details><summary>Does CRM From Within read every employee’s email?</summary><p>No. The company would choose which accounts, history and sources are approved. The exact permission, hosting, retention and contractual controls still need to be designed and proven before real use.</p></details>
          ...
          <details><summary>How is this different from an AI CRM that connects to email?</summary><p>Existing AI CRMs already populate contacts, deals and activity from email and meetings. CRM From Within aims to go further: discover the company’s own structure, build owned software around it, ask why people work as they do and improve installations from measured lessons across customers.</p></details>
          <details><summary>Do all customers end up with the same CRM?</summary><p>No. Reusable lessons improve how CRM From Within recognises needs and builds reliable capabilities, but each company’s CRM structure, rules, code and private memory remain its own.</p></details>
      ...
      <footer className="site-footer shell">
        <a className="brand footer-brand" href="#top"><Image src="/crm-from-within-mark.svg" width={34} height={34} alt="" unoptimized /><span>CRM From Within</span></a>
