    ...
    <main className="investor-page">
      ...
      <section className="section flywheel-section shell" id="flywheel">
        ...
        <div className="flywheel-grid">
          ...
          <article className="flywheel company-flywheel"><div className="flywheel-title"><span>02</span><div><small>ACROSS EVERY CUSTOMER</small><h3>The installed-base flywheel</h3></div></div><div className="wheel-loop-visual"><strong>More installations</strong><i>→</i><strong>More measured lessons</strong><i>→</i><strong>Better builds</strong><i>→</i><strong>Less manual effort</strong><i>→</i><strong>Better value</strong></div><p>New customers start from stronger priors. Existing customers receive relevant improvements first discovered elsewhere.</p></article>
        </div>
        <div className="flywheel-guardrail"><strong>The transfer unit is a proven lesson—not a customer’s private data.</strong><p>If that boundary cannot be made technically, contractually and visibly trustworthy, the compounding strategy does not work.</p></div>
      </section>
