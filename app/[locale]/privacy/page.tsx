    ...
    <main className="legal-page" lang={swedish ? 'sv' : 'en'}>
      ...
      <article className="legal-content shell">
        ...
        <p className="legal-lead">{swedish
          ? 'Company Native drivs av Yusuf Young AB i Sverige. Bara det som behövs för att svara på din kontaktförfrågan eller skapa, visa och följa upp CRM-planen du ber om samlas in.'
          : 'Company Native is operated by Yusuf Young AB in Sweden. Only what is needed to reply to your contact request or create, deliver and follow up on the CRM plan you request is collected.'}</p>

        <section>
          <h2>{swedish ? 'Det som sparas' : 'What is stored'}</h2>
          <p>{swedish
            ? 'Om du kontaktar Company Native direkt sparas din jobbmejl och meddelandet du väljer att lämna. Om du använder CRM-planen sparas samtalet, din jobbmejl, planen som skapas och grundläggande uppgifter om ditt företag, hur du följer leads och kunder idag, teamets storlek och problemet du beskriver.'
            : 'If you contact Company Native directly, your work email and optional message are stored. If you use the CRM plan, the conversation, your work email, the plan produced and the basic facts you provide about your company, current way of tracking leads and customers, team size and business problem are stored.'}</p>
        </section>
        <section>
        ...
        <section>
          ...
          <p>{swedish
            ? 'Svaren behandlas av en AI-modell genom Company Natives Cloudflare-miljö och resultatet lagras i Company Natives Cloudflare-databas. Använd inte CRM-planen för känsliga kunduppgifter, personnummer, hälsodata, inloggningsuppgifter eller konfidentiella affärsdetaljer.'
            : 'Answers are processed by an AI model through the Company Native Cloudflare environment and the result is stored in the Company Native Cloudflare database. Do not use the CRM plan for sensitive customer data, government identifiers, health data, credentials or confidential deal details.'}</p>
        </section>
        <section>
